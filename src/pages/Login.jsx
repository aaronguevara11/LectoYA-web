            ...
            <div className="w-full bg-white rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-gray-900 ">Correo electronico:</label>
                        ...
                        <div className="text-sm font-light w-full h-8 flex items-center">
                            <a href="/Registro/:docente" className="font-medium text-primary-600 hover:underline dark:text-primary-500 w-full text-center flex items-center justify-center bg-black text-white mx-2 rounded-md h-[43px]">Crear Cuenta Docente</a>
                            <a href="/Registro/:alumno" className="font-medium text-primary-600 hover:underline dark:text-primary-500 w-full text-center flex items-center justify-center bg-black text-white mx-2 rounded-md h-[43px]">Crear Cuenta Alumno</a>
                        </div>
                    </form>
                </div>
            </div>
