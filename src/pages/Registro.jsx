...
export const Registro = ({ruta}) => {
    ...
    const registerAxiosAlumno = async (correo, contraseña, apaterno, amaterno, nombres, dni, numero) => {
    ...
    const registerAxiosDocente = async (correo, contraseña, apaterno, amaterno, nombres, dni, numero) => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(user)
        if (user == ":alumno") {
            await registerAxiosAlumno(correo, contraseña, apaterno, amaterno, nombres, dni, numero);
        } else if (user == ":docente") {
            await registerAxiosDocente(correo, contraseña, apaterno, amaterno, nombres, dni, numero);
        }
                    ...
                    <div className="w-full bg-white rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">Nombres:</label>
                                    <input type="text" name="nombre" id="nombre" className="h-[45px] bg-slate-100   border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Nombres" required="" value={nombres} onChange={handleInputChangeNombres} />
                                </div>

                                <div className="flex">
                                    <section className="w-2/4 mr-1">
                                        <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">Apellido Paterno:</label>
                                        <input type="text" name="apaterno" id="apaterno"
                                            ...
                                            placeholder="Apellido Paterno" required="" value={apaterno} onChange={handleInputChangeApaterno} />
                                    </section>

                                    <section className="w-2/4 ml-1">
                                        <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">Apellido Materno:</label>
                                        <input type="text" name="amaterno" id="z"
                                            className="h-[45px] bg-slate-100   border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Apellido Materno" required="" value={amaterno} onChange={handleInputChangeAmaterno} />
                                    </section>
                                </div>
                                ...
                                <div className="flex">
                                    <section className="w-2/4 mr-1">
                                        <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">DNI :</label>
                                        <input type="text" name="dni" id="dni"
                                            className="h-[45px] bg-slate-100   border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Apellido Paterno" required="" value={dni} onChange={handleInputChangeDni} />
                                    </section>

                                    <section className="w-2/4 ml-1">
                                        <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">Numero :</label>
                                        <input type="text" name="numero" id="numero"
                                            className="h-[45px] bg-slate-100   border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Apellido Materno" required="" value={numero} onChange={handleInputChangeNumero} />
                                    </section>
                                </div>
                                ...
                                <div>
                                    <label htmlFor="email" className="block mb-2 text-[18px] font-medium text-white ">Correo electronico:</label>
                                    <input type="email" name="email" id="email" className="h-[45px] bg-slate-100   border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@gmail.com" required="" value={correo} onChange={handleInputChangeCorreo} />
                                </div>
                                <div>
