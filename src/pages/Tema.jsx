...
export const Tema = ({ idCurso, idTema, setIdJuego, setNombreJuego, setIdTema, ruta }) => {
  ...
  const mostraRespuestas = async (idTema, nameGame) => {
    try {
      const response = await axios.get(`${ruta}/juegos/verRespuesta/${idTema}`, {
        headers: {
          Authorization: token,
        },
      });
        ...
        <>
          ...
          <section className="flex flex-col overflowx-auto bg-white relative w-full h-full ">
                      ...
                      <div className="w-1/6 h-full flex items-end justify-center px-4">
                        <div className="w-5/5 h-full flex items-center justify-center">
                          ...
                          <Button
                            ...
                            onClick={() => clickViewResponse(item.id, item.nombreJuego)}>
                            <section className='w-4/5 flex justify-center text-lg text-white'>
                              Ver Respuestas</section>
            ...
            <div className="w-full top-1/2 right-1/2">
              ...
              >
                <Box
                  className="w-[600px] h-auto flex flex-col justify-center px-12 bg-white rounded-[15px] p-4 ml-72">
                  ...
                  <>
                    <h1 className="text-green-600 font-bold">RESPUETAS ALUMNOS</h1>
                          ...
                          <>
                            {respuesta.map((item) => (
                              <div key={item.id}>
                                ...
                                <h2 className="text-blue-600 font-bold">ENUNCIADO</h2>
                                <h2>{enunciado}</h2>
                                <p className="text-blue-600 font-bold">PREGUNTA</p>
                                <p>{pregunta}</p>
                          ...
                          <>
                            {respuesta.map((item) => (
                              ...
                              <div key={item.id}>
                                ...
                                <p className="text-blue-600 font-bold">RESPUESTA</p>
                                <h2>
                                  {item.respuesta}
                                </h2>
                              </div>
                          ...
                          <>
                            {respuesta.map((item) => (
                              ...
                              <div key={item.id}>
                                ...
                                <p className="text-blue-600 font-bold">ORDENA ALUMNO</p>
                                <h2>
                                  orden 1: {item.orden1}
                                </h2>
                                <h2>
                          ...
                          <>
                            ...
                            {respuesta.map((item) => (
                              ...
                              <div key={item.id}>
                                ...
                                <p className="text-blue-600 font-bold">Palabra 1</p>
                                <h1>
                                  {item.palabra1}
                                </h1>
                                <p className="text-blue-600 font-bold">Significado 1</p>
                                <h2>
                                  {item.significado1}
                                </h2>

                                <p className="text-blue-600 font-bold">Palabra 2</p>
                                <h1>
                                  {item.palabra2}
                                </h1>
                                <p className="text-blue-600 font-bold">Significado 2</p>
                                <h2>
                                  {item.significado2}
                                </h2>


                                <p className="text-blue-600 font-bold">Palabra 3</p>
                                <h1>
                                  {item.palabra3}
                                </h1>
                                <p className="text-blue-600 font-bold">Significado 3</p>
                                <h2>
                                  {item.significado3}
                                </h2>
